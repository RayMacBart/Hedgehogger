...
class Hedgehog(Strategy):
   ...
   def init(self):
      ...
      self.PSAR = self.I(helpers.PSAR, self.PSAR_df[f'PSARl_{self.psar_af0}_{self.psar_max_af}'], 
      ...
      self.lowerband = self.I(helpers.lowerband, self.bbands_df[f'BBL_{self.bbands_window}_2.0'], name='lower bband')
      self.upperband = self.I(helpers.upperband, self.bbands_df[f'BBU_{self.bbands_window}_2.0'], name='upper bband')
      self.middleband = self.I(helpers.middleband, self.bbands_df[f'BBM_{self.bbands_window}_2.0'], name='middle bband')
      self.bandwidth = self.I(helpers.bandwidth, self.bbands_df[f'BBB_{self.bbands_window}_2.0'], name='bband width')
      ...
      self.trend = self.I(helpers.trend, self.data.Close, self.RSI_upper_bound, self.RSI_lower_bound, self.RSI)
